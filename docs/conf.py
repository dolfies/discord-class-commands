...
extlinks = {
    'issue': ('https://github.com/dolfies/discord-class-commands/issues/%s', 'GH-'),
}
...
resource_links = {
    ...
    'issues': 'https://github.com/dolfies/discord-class-commands/issues',
    'discussions': 'https://github.com/dolfies/discord-class-commands/discussions',
    'examples': f'https://github.com/dolfies/discord-class-commands/tree/{branch}/examples',
}
...
latex_documents = [
    ('index', 'discord-class-commands.tex', 'discord-class-commands Documentation', 'Dolfies', 'manual'),
]
...
man_pages = [('index', 'discord-class-commands', 'discord-class-commands Documentation', ['Dolfies'], 1)]
...
texinfo_documents = [
    (
        ...
        'discord-class-commands Documentation',
        'Dolfies',
        'discord-class-commands',
