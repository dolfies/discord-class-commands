...
extlinks = {
    'issue': ('https://github.com/iDevision/discord-class-commands/issues/%s', 'GH-'),
}
...
copyright = '2022-present, iDevision'
...
resource_links = {
  ...
  'issues': 'https://github.com/iDevision/discord-class-commands/issues',
  'discussions': 'https://github.com/iDevision/discord-class-commands/discussions',
  'examples': f'https://github.com/iDevision/discord-class-commands/tree/{branch}/examples',
}
...
latex_documents = [
  ('index', 'discord-class-commands.tex', 'discord-class-commands Documentation',
   'iDevision', 'manual'),
]
...
man_pages = [
    ('index', 'discord-class-commands', 'discord-class-commands Documentation',
     ['iDevision'], 1)
]
...
texinfo_documents = [
  ('index', 'discord-class-commands', 'discord-class-commands Documentation',
   'iDevision', 'discord-class-commands', 'One line description of project.',
   'Miscellaneous'),
]
